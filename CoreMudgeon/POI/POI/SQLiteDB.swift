...
@objc class SQLiteDB {
	...
	let DEFAULT_DB_NAME = "data.db"
	let DEFAULT_QUEUE_LABEL = "SQLiteDB"
	...
	required init(path:String, options:[String:Any]) {

		// Set queue
		queue = dispatch_queue_create(DEFAULT_QUEUE_LABEL, nil)
